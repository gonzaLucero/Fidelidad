...
namespace Hexacta.Core.Tools.Utilities
{
    public class PrinterHelper
    {
        ...
        /// This function opens the  file, gets all its bytes & send them to print.
        /// </summary>
        /// <param name="szPrinterName">Printer Name</param>
        /// <param name="szFileName">File Name</param>
        /// <returns>true on success, false on failure</returns>
        public static bool SendFileToPrinter(string fileName)
        {
            try
            {
                ...
                if (!bool.TryParse(ConfigurationManager.AppSettings["useDefaultPrinter"], out useDefaultPrinter))
                {
                    useDefaultPrinter = true;
                }

                if (useDefaultPrinter || string.IsNullOrEmpty(ConfigurationManager.AppSettings["printerName"]))
                {
        ...
        /// </summary>
        /// <param name="szPrinterName">Printer Name</param>
        /// <param name="pBytes">No. of bytes in the file</param>
...
/*usage
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                RawPrinterHelper.SendFileToPrinter(@"E:\XYZDocs\XYZ.txt");
            }
